...
from betting.views import create_group, join_group, leave_group, remove_group, get_all_groups
...
class GroupEndpointsTestCase(APITestCase):
    def setUp(self):
        ...
        self.Group =Group.objects.create(owner=self.owner, name='TestGroup', created_at=timezone.now())
